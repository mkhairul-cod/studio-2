      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto mt-4">
            Jelajahi artikel, tips, dan wawasan terbaru dari dunia akademik untuk mendukung penelitian dan pengembangan diri Anda.
          </p>
        </div>
        ...
        {filteredArticles.length === 0 && (
          <div className="text-center mt-16 col-span-full bg-background/80 p-8 rounded-lg shadow-sm">
            ...
            <p className="text-muted-foreground text-lg mt-2">
              Belum ada artikel dalam kategori "{activeCategory}". Kami sedang menyiapkannya untuk Anda!
            </p>
          </div>
        )}
        ...
        <section className="mt-16 md:mt-24 text-center bg-card p-8 md:p-12 rounded-lg shadow-lg border">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mt-3 mb-6">
            Kami mengundang para akademisi, peneliti, dan praktisi untuk berbagi wawasan. Kirimkan artikel Anda untuk dipublikasikan di platform kami.
          </p>
