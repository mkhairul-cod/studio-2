        ...
        <Card className="w-full max-w-lg text-center">
          ...
          <CardContent>
            <p className="text-muted-foreground">
              Terima kasih telah menghubungi kami. Tim kami akan segera merespon pesan Anda melalui email.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-lg text-muted-foreground">
            Punya pertanyaan, saran, atau butuh informasi lebih lanjut? Jangan ragu untuk menghubungi kami melalui formulir di bawah ini atau kontak yang tersedia.
          </p>
        </div>
        ...
        <Card className="mx-auto w-full max-w-2xl">
          <CardHeader>
            ...
            <CardDescription>
              Kami akan merespon sesegera mungkin.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
