...
export default function FloatingWhatsApp() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-50 bg-green-500 text-white rounded-full p-3 shadow-lg hover:bg-green-600 transition-transform duration-300 ease-in-out hover:scale-110"
